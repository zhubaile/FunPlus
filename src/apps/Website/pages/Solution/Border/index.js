        ...
        <div className='service'>
          <div className='service-conter'>
            <div className='service-conter-top'>
              <div>
                <div style={{ backgroundImage: `url(${require("@img/solution/logistics/wl2.png")})`,width: '395px', height: '60px', textAlign: 'center', lineHeight: '60px',fontWeight: '400',fontSize: '36px' }}> <FormattedMessage id='app.website.jjborder.service1.div' /></div>
        ...
        <div className='commonly-right'>
          <div className='commonly-conter'>
            <div className='commonly-conter-left'>
              <img
                src={require('@img/solution/border/kj_1.png')}
              />
            </div>
            ...
            <Tab shape='wrapped' tabPosition='left'>
              <Tab.Item title={formatMessage({ id: 'app.website.jjborder.tab.title1' })} key="1">
                <div className='solution-border-botton-tab'>
                  <ul>
                    <li>
                      <img src={require('@img/solution/border/kj11.png')} />
                    ...
                    <li>
                      <img src={require('@img/solution/border/kj12.png')} />
                    ...
                    <li>
                      <img src={require('@img/solution/border/kj13.png')} />
              ...
              <Tab.Item title={formatMessage({ id: 'app.website.jjborder.tab.title2' })} key="2">
                <div className='solution-border-botton-tab'>
                  <ul>
                    <li>
                      <img src={require('@img/solution/border/kj14.png')} />
                    ...
                    <li>
                      <img src={require('@img/solution/border/kj15.png')} />
                    ...
                    <li>
                      <img src={require('@img/solution/border/kj16.png')} />
              ...
              <Tab.Item title={formatMessage({ id: 'app.website.jjborder.tab.title3' })} key="3">
                <div className='solution-border-botton-tab'>
                  <ul>
                    <li>
                      <img src={require('@img/solution/border/kj17.png')} />
                    ...
                    <li>
                      <img src={require('@img/solution/border/kj18.png')} />
                    ...
                    <li>
                      <img src={require('@img/solution/border/kj19.png')} />
              ...
              <Tab.Item title={formatMessage({ id: 'app.website.jjborder.tab.title4' })} key="4">
                <div className='solution-border-botton-tab'>
                  <ul>
                    <li>
                      <img src={require('@img/solution/border/kj20.png')} />
                    ...
                    <li>
                      <img src={require('@img/solution/border/kj21.png')} />
                    ...
                    <li>
                      <img src={require('@img/solution/border/kj22.png')} />
        ...
        <div className='solution-border'>
          ...
          <div className='solution-border-botton'>
            <div className='solution-border-botton-business'>
              <div>
                <img src={require('@img/solution/border/06.png')} />
              ...
              <img src={require('@img/solution/border/kj9.png')} />
              <div>
                <img src={require('@img/solution/border/07.png')} />
              ...
              <img src={require('@img/solution/border/kj9.png')} />
              <div>
                <img src={require('@img/solution/border/08.png')} />
        ...
        <div className="advantages">
          <div className="advantages_main">
            ...
            <div className="advantages_bottom">
              <ul>
                <li className='boxs'>
                  <img src={require('@img/solution/border/kj2.png')} />
                ...
                <li className='boxs'>
                  <img src={require('@img/solution/border/kj3.png')} />
                ...
                <li className='boxs'>
                  <img src={require('@img/solution/border/kj4.png')} />
                ...
                <li className='boxs'>
                  <img src={require('@img/solution/border/kj5.png')} />
