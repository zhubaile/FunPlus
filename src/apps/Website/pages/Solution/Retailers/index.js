        ...
        <div className='service'>
          <div className='service-conter'>
            <div className='service-conter-top'>
              <div>
                <div style={{ backgroundImage: `url(${require("../../../../../assets/img/solution/logistics/wl2.png")})`,width: '395px', height: '60px', textAlign: 'center', lineHeight: '60px',fontWeight: '400',fontSize: '36px' }}><FormattedMessage id='app.website.jjretailers.service1.div' /></div>
        ...
        <div className='service'>
          <div className='service-conter'>
            ...
            <div className='service-conter-bottons'>
              <img src={require('../../../../../assets/img/solution/retailers/ds2.png')} alt="" />
        ...
        <div className='scene'>
          <div className='scene-conter'>
            ...
            <div className='scene-conter-xxl'>
              <img src={require('../../../../../assets/img/solution/retailers/fn-ds.png')} alt="" />
            </div>
          </div>
        </div>
        {/*  */}
