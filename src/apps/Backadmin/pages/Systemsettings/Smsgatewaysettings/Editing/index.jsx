  ...
  render() {
    ...
    return (
      <div className="editing">
        <div className='editing_title'>
          <h2 style={{ display: 'inline-block' }}>编辑</h2>
          <span style={{ fontSize: '38px', color: '#666666', float: 'right', cursor: 'pointer' }} onClick={this.editingclose.bind(this)}>×</span>
        </div>
        <div className='editing_content'>
          ...
          <FormBinder name='passwordTwo'>
            ...
            <div className='editing_content_bottom'>
